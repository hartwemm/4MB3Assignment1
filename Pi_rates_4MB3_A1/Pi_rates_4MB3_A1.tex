...
\begin{proof}[Solution]
	...
	As can be seen by the phase portrait developed in lecture, the equilibrium points with $S<1/\mathcal{R}_0$ are asymptotically stable and the equilibrium points with  $S>1/\mathcal{R}_0$ are unstable.
	
\begin{figure}[h]
\begin{center}
		\includegraphics[width=5cm]{images/4MB3_A1_2d.png}
\end{center}
\end{figure}
